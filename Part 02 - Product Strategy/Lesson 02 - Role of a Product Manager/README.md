...
![The PM Venn Diagram - Design, Business, and Technology](./lesson_02_figure_01.jpg)

The PM needs to have a background in all those three dimensions to be successful. Figure 2 shows the roles of a PM.

![The roles of a Product Manager](./lesson_02_figure_02.png)
...
![Company Size & PM Types](./lesson_02_figure_03.png)
...
![Product Led Philosophy](./lesson_02_figure_04.png)

EXAMPLE: Amazon Prime - easy, fast and convenient

##### 2. Engineering led

![Engineering Led Philosophy](./lesson_02_figure_05.png)

EXAMPLE: Google Glass - Amazing technology but not solving a problem

##### 3. Product + Eng partnership (hybrid)

![Product + Eng partnership Philosophy](./lesson_02_figure_06.png)
...
![Type of Users](./lesson_02_figure_07.png)
...
2. Creating solutions: The PM will build strategies for how to solve the problem;
3. Planning: How to split the product into smaller deliverables;
4. UX design: Building mocks, reviewing the mock, running usability tests;
5. Implementation: Following the development progress, answering any doubts about the requirements;
...
|User interviews (_Input from users / customers_)|Talks directly to the user to understand their needs. It is an excellent way to create empathy (you will be able to put the users' shoes).|
|Stakeholder interviews (_Input from cross functional partners_)|Interview people from your company to understand their requirements to reach the business objectives.|
...
![Roadmap Example - Items](./lesson_02_figure_08.png)
...
![Roadmap Example - Team](./lesson_02_figure_09.png)
...
![PRD Example](./lesson_02_figure_10.png)
