...
|  User Research   | Ethnographies, interviews, and focus groups.<br>It’s is super important to go out and talk to users.           |
...
-   You have a limited amount of time, and;
-   Each problem has different levels of impact (and you want/should
    maximize it).

Also, your problem needs to meet some Business Goals to survive.

![](./Figure/1_3.png)

Figure 1 shows the tradeoff between **Business Goals** (increasing
Revenue, increasing New Users, increasing Engagement, Costs Reduction,
Churn Reduction, etc.) and **Problems**.

![Viable Product Opportunities](./Figure/lesson_03_figure_01.png)
...
> You can have an **incredible team** and **develop an excellent piece
> of technology**, but if this product does **not resonate** with the
> market, none of that will matter.
...
|      Trends      | Can also provide crucial insights. Some sources of trends: <br>• Mary Meeker’s Internet Trends<br>• Google Trends |

#### Further Readings

To learn more about understanding the market check out:

-   [Mary Meeker’s Internet Trends](./Data/Internet_Trends_2019.pdf)
-   [12 Things about Product/Market
    Fit](./Data/12%20Things%20about%20Product-Market%20Fit_Future.pdf)
...
There are 3 options to deliver health tracking.

![](./Figure/1_7.png)

|          Way          | Description                                |
|:---------------------:|:-------------------------------------------|
|       Hardware        | Build specific hardware like a smart watch |
| “in-between” solution | Build an app that run in other watches     |
|       Software        | Build an app                               |

### Pros & Cons of each alternatives

![](./Figure/1_8.png)

-   *Obs.: Investment to build*
...
Learn more about identifying target users:

-   [Are You Ready to Change Your Target
    Customer?](./Data/Are%20You%20Ready%20to%20Change%20Your%20Target%20Customer.pdf)
-   [How to Define Your Target Market: A Guide to Audience
    Research](./Data/What%20Is%20a%20Target%20Market%20(And%20How%20to%20Find%20Yours%20in%202022).pdf)
...
**TAM**, or **total addressable market**, is a measure of the revenue
opportunity for a product.

Keep in mind that TAM is not a measure of your revenue or future
revenue. Instead, it allows you to understand the size of the market if
you had 100% of the market. A larger TAM indicates a larger opportunity,
with more demand for a particular product. However, just because there’s
a large TAM does not mean that a product is guaranteed to be successful…

There are lots of other factors that will come into play, like
competition.
...
larger opportunity. However, a large TAM **does not guarantee your
...
-   ARPU stands for The average amount of revenue you receive for each
    user you have, usually measured by year.

There are 3 (three) ways to calculate the TAM:
...
Read more about calculating TAM:

-   [How to calculate your total addressable market and make a great TAM
    slide for
    investors](./Data/How%20to%20calculate%20your%20total%20addressable%20market%20and%20make%20a%20great%20TAM%20slide%20for%20investors%20-%20For%20Entrepreneurs.pdf)
