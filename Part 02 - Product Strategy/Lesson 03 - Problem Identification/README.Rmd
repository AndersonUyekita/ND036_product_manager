---
title: '`Lesson 03` Problem Identification'
...
* Each problem has different levels of impact (and you want/should maximize it).

Also, your problem needs to meet some Business Goals to survive.

![](./Figure/1_3.png)

Figure 1 shows the tradeoff between **Business Goals** (increasing Revenue, increasing New Users, increasing Engagement, Costs Reduction, Churn Reduction, etc.) and **Problems**.
...
![Comparison between No Produc/Market Fit vs Product/Market Fit](./Figure/lesson_03_figure_04.png)
...
* [12 Things about Product/Market Fit](./Data/12 Things about Product-Market Fit_Future.pdf)
...
* [Are You Ready to Change Your Target Customer?](./Data/Are You Ready to Change Your Target Customer.pdf)
* [How to Define Your Target Market: A Guide to Audience Research](./Data/What Is a Target Market (And How to Find Yours in 2022).pdf)
...
![Meet John-- our new year resolution user Close](./Figure/lesson_03_figure_07.png)

![Meet Sally-- our first time marathon runner](./Figure/lesson_03_figure_08.png)

![Meet Chris-- our avid runner who wants to beat his record](./Figure/lesson_03_figure_09.png)
...
* [How to calculate your total addressable market and make a great TAM slide for investors](./Data/How to calculate your total addressable market and make a great TAM slide for investors - For Entrepreneurs.pdf)
...
ROI (return on investment) is a measure used to prioritize activities/projects of a product. In other words, ROI is a way to measure the efficiency of an investment. Figure 15 shows the ROI formula.
...
![ROI Calculation for Software Development](./Figure/lesson_03_figure_16.png)
...
* [Product development through hypotheses](./Data/Product development through hypotheses_ formulating hypotheses.pdf)
* [Customer Development with Steve Blank: Hypothesis Testing](./Data/Customer Development Steve Blank.pdf)
...
* [Sample Business Case](./Data/Making Technology Investments Profitable - 2012 - Keen - Sample Business Case.pdf)
* [5 Steps to Write a Solid Business Case](./Data/Five Steps to Develop a Solid Business Case with Examples — Chase Consulting_ Business Case Specialists.pdf)
