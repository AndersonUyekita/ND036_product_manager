---
title: '`Lesson 04` Vision & Strategy'
...
For this reason, the vision will guide your strategy and, consequently, the features roadmap.
...
Vision serves as a **north sta**r to guide the team and decision making as your product is being developed. It explains what you’re building, who it’s for, and why it matters. Vision also gets the team excited and motivated about building the product.

**Further readings**

* [Product Vision](./Data/What is a Product Vision Statement_ _ Definition and Overview.pdf)
* [4 Experts Reveal How to Create a Strong Product Vision](./Data/4 Experts Reveal How to Create a Strong Product Vision.pdf)
...
* [What is Good Product Strategy?](./Data/What is Good Product Strategy_. “What is your Product Strategy_ YOU… _ by Melissa Perri _ Medium.pdf)
...
* [Business Model Canvas Examples](./Data/Business Model Canvas Examples _ Automobile & Amazon Case Studies.pdf)
* [10 Most Popular Startup Revenue Models](./Data/The 10 Most Popular Startup Revenue Models.pdf)
...
![Business Model Solution for Fitness Tracker](./Figure/lesson_04_figure_09.png)
...
![Critical Points of Competitive Analysis](./Figure/lesson_04_figure_10.png)
...
Competitive analysis in its simplest form is identifying other similar products in the market, including the users each product is targeting. At a high level, competitive analysis includes:
...
![Exercise Solution of Competitive Analysis](./Figure/lesson_04_figure_11.png)
...
* [What is an MVP?](./Data/What is a Minimum Viable Product.pdf)
* [Types of MVPs and Examples](./Data/8 Minimum Viable Product Examples to Start a Digital Business.pdf)
* [15+ Examples MVPs](./Data/15+examples of successful MVPs.pdf)

## 13. KPI's

**KPIs**, or _Key Performance Indicators_, are metrics that measure the performance of your product against your strategy. They capture the big picture and help you to understand how well your product is working (or isn’t working) and are aligned with business objectives. Additionally, they help to measure how changes you make to your product move the needle (or don’t)
...
* [4 Things to Remember When Defining KPIs](./Figure/4 Things to Remember When Defining KPIs.pdf)
* [18 KPI Examples Explained](./Figure/30 KPIs To Measure Performance & How To Choose & Track Them - ClearPoint Strategy.pdf)

## 14. Exercise: KPI's

Identify KPIs for your fitness tracker product. Make sure to keep in mind the components that you mapped out when putting together your business model canvas. Think about how you can translate some of those things into KPIs across business, product, quality, and development dimensions.
...
You’ve reached the end of the Vision and Strategy lesson. We covered the following topics:
